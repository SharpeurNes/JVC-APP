  ...
  return (
    ...
    <div className="msg" data-message-id={msg.id}>
      ...
      <img className="avatar-md"
        ...
        alt="avatar"
        onClick={() => setView({ name: 'profil', data: msg.author })}
        ...
        <div className="msg-top">
          <div className="msg-author-block">
            <div className="author-info-line">
              <span className="msg-author" style = {{color: isUser ? '#e5705e' : '#a8a8a8', cursor: 'pointer'}} onClick={() => setView({ name: 'profil', data: msg.author })}>{msg.author}</span>
